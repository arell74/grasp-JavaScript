...
document.addEventListener('click', async function(e) {
    if(e.target.classList.contains('modal-movie-btn'));
...
function getMovieDetail(imdbid) {
    return fetch("http://www.omdbapi.com/?apikey=e18c5f67&i=" + imdbid)
      .then((response) => response.json())
      .then((m) => m);
}
...
function getMovies(keyword) {
    return fetch('http://www.omdbapi.com/?apikey=e18c5f67&s=' + keyword)
    .then(response => response.json())
  ...
  return `
            <div class="col-md-4 my-3">
                ...
                <div class="card-body">
                    ...
                    <a href="#" class="btn btn-primary modal-movie-btn" data-bs-toggle="modal" data-bs-target="#movieButtonModal" data-imdbid="${m.imdbID}">Show Details</a>
                </div>
                </div>
            </div>
            `;
